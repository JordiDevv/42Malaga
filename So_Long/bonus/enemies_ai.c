...
static void draw_sprite(data_struct *data_game, map_point cell, 
...
static void oso_turn(data_struct *data_game, map_point *oso_pos, 
    int ind_move)
{
...
static void mantis_turn(data_struct *data_game, map_point *mantis_pos, 
    int ind_move)
{
...
static int  can_move(data_struct *data_game, map_point en_pos, int ind_move)
{
    if ((ind_move == 0 && 
