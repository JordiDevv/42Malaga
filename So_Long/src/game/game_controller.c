...
static void	free_images(data_struct *data_game)
{
...
static void	get_images(data_struct *data_game)
{
...
static void	display_image(data_struct *data_game, char c, int i, int j)
{
	if (c == '1')
...
static void	display_map(data_struct *data_game)
{
	int	i;
	int	j;
