...
static void	init_data_rest(t_data_struct *data_game)
{
	int	i;
	int	j;
...
static void	parse_map(t_data_struct *data_game, char *line, int i)
{
	char	**temp;
	char	**temp_aux;
...
static void	map_to_matrix(t_data_struct *data_game)
{
	char	*line;
	int		i;
	int		height;
