...
#define ENTIND_MSG GREEN "ENTER THE INDEX OF THE DESIRED CONTACT\n" RESET
#define ENTIND_MSG_L 51

#define EXIT_MSG GREEN "THIS PHONEBOOK WILL SELF-DESTRUCT IN HALF A SECOND\n" RESET
#define EXIT_MSG_L 63